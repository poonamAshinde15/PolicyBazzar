...
public class Utility {
	...
	public static void takeScreenshot(WebDriver driver, String fileName) throws IOException
	{
	    ...
	    File dest = new File("C:\\Users\\Pk\\eclipse-workspace\\PolicyBazar\\Screenshots\\"+fileName+"-"+str+".png");            
	...
	{
		FileInputStream myFile = new FileInputStream("D:\\\\Poonam Class Assignments and notes\\\\Poonam1.xlsx");
